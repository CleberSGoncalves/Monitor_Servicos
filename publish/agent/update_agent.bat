...
echo 1. Consultando e baixando ultima release no GitHub (Servico em execucao)...
...
if exist "%WORK_DIR%\agent_download.zip" (
    echo 2. Extraindo pacote de atualizacao...
    ...
    echo [ERRO] Nao foi possivel baixar o pacote de atualizacao. Servico mantido em execucao.
    rmdir /s /q "%WORK_DIR%" >nul 2>&1
)
